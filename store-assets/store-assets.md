...
• Cross-Venue Arb — funding & price basis vs major centralized and
  decentralized perp venues, with a 72h spread chart.
...
All data is read from public market-data and news APIs and may be delayed
or inaccurate.
...
host_permissions（各API）	To fetch public, read-only market data for the selected coin: Hyperliquid market and funding data, third-party analytics endpoints for liquidation and protocol stats, several public exchange APIs for cross-venue funding/price basis, and public financial-data and news providers for equities, headlines, and ETF-flow data. All endpoints are read-only and return publicly available data.
